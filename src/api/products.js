const url = [
    {id: 1, url: '/static/images/ecommerce/1.png'},
    {id: 1, url: '/static/images/ecommerce/2.png'},
    {id: 1, url: '/static/images/ecommerce/3.png'},
    {id: 1, url: '/static/images/ecommerce/4.png'},
    {id: 2, url: '/static/images/invoice/1.png'},
    {id: 2, url: '/static/images/invoice/2.png'},
    {id: 2, url: '/static/images/invoice/3.png'},
    {id: 2, url: '/static/images/invoice/4.png'},
    {id: 3, url: '/static/images/ordermade/1.png'},
    {id: 3, url: '/static/images/ordermade/2.png'},
    {id: 3, url: '/static/images/ordermade/3.png'},
    {id: 4, url: '/static/images/oldbook/1.png'},
    {id: 4, url: '/static/images/oldbook/2.png'},
    {id: 5, url: '/static/images/mapapp/1.png'},
    {id: 5, url: '/static/images/mapapp/2.png'},
    {id: 5, url: '/static/images/mapapp/3.png'},
    ]

const database = [
    {
        id : 1,
        name : "Stripe E-commerce Site",
        url :  'https://laravel-stripe-ecommerce.herokuapp.com',
        githuburl: 'https://github.com/hirakumorishima02/laravel-stripe-E-commerce',
        content : 'Stripeを導入した単発・サブスクリプション決済対応ECサイトです。' ,
        photo :  url,
    },
    {
        id : 2,
